...
export default function NavAdmin({salir}) {
    ...
    return (
        <Fragment>
            ...
            <Link className="nav-link text-dark" to='/crearcategoria' >Crear Categoría</Link>
            <span className="nav-link text-dark" onClick={()=>{salir()}}>Salir</span>
        </Fragment>
    )
}
